...
const AgriInputScreen = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      price: 199,
      image: require('../../assets/logo.png'), // Replace with actual product image
      description: 'Durable irrigation pipes for farming'
    },
    {
      id: 'agri-6',
      ...
      price: 349,
      image: require('../../assets/logo.png'), // Replace with actual product image
      description: 'Boost your plant growth naturally'
    },
  ];
  ...
  const addToCart = async (product: Product) => {
    try {
      ...
      // Add source property to identify as agri-input
      const productWithSource = { ...product, source: 'agri-input' as const };
  ...
  const navigateToCart = () => {
    // Pass cart items to cart screen
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Agri Inputs</Text>
        </View>
